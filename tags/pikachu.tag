  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col">
        ...
        <h4 show={happy>= 60 }> I love CHU!
        </h4>
        <h4 show={hungry>= 30}> Feed me!
          <h4>
            <h4 show={strength>= 30
              <!--&& 16 <= hungry <=25 -->}> Let's hit the battleground!
            </div>
          ...
          <div class="row">
            <div class="col states">
              <ul>
                <li>Happy: {happy}
                  <span id="happy"></span></li>
                <li>Hungry: {hungry}
                  <span id="hungry"></span></li>
                <li>Strength: {strength}
                  <span id="strength"></span></li>
              </ul>
            </div>
          </div>
          <!-- Pikachu Reactions -->
        ...
        <script>
          ...
          feed(event) {
            ...
            if (this.hungry <= 15) {
              this.imgPikachu =//  else if (this.hungry >= 30) {    this.imgPikachu = "https://i.imgur.com/b0R6GJ1.gif"  }
              "https://orig00.deviantart.net/edc3/f/2014/032/2/4/fatpikachu_gif_by_butt_prince_ike-d74pbx9.gif"
            } else {
              this.imgPikachu = "https://media.giphy.com/media/zdU2mUIL5S012/giphy.gif"
            }
          }
